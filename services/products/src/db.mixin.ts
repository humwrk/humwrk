...
// File taken from @humwrk/db-mixin since we have little problems
// with package management (GitHub) and that's our temporary solution,
// it should be resolved in next cycle/sprint.
